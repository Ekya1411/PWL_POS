    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($kategori)
                ...
                <a href="{{ url('barang/data_kategori') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
                <form method="POST" action="{{ url('/barang/kategori/' . $kategori->kategori_id . '/update') }}" class="formhorizontal">
                    @csrf
            ...
            method PUT -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('barang/data_kategori') }}">Kembali</a>
                        </div>
                    </div>
                </form>
            @endempty
