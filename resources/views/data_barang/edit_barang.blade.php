    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($barang)
                ...
                <a href="{{ url('barang/data_barang') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
                <form method="POST" action="{{ url('/barang/' . $barang->barang_id . '/update') }}" class="formhorizontal">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('barang/data_barang') }}">Kembali</a>
                        </div>
                    </div>
                </form>
            @endempty
